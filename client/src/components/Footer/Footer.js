        ...
        <footer>
            <div className="footer__container">
                    ...
                    <div className="footer__contact__container">
                        ...
                        <ul className="footer__contacts">
                            <li className="footer__contact">
                                <LocalPhoneIcon /> <span>+91-9510418500</span>
                            </li>
                            <li className="footer__contact">
                                <EmailIcon /> <span>vkeepers@vintage.com</span>
                            </li>
                            <li className="footer__contact">
                                <LocationOnIcon /> <span>Surat, India</span>
                            </li>
                        </ul>
                    </div>
                ...
                <div className="fotter__copyright__container">
                    <ul className='nav'>
                        <li className="footer__copyright">©2024 Vintage Keepers Ltd. |</li>
                        <li className="footer__privacy__policy">| Soumya Jadoun |</li>
                        <li className="footer__privacy__policy">| Zaineb Rupawala</li>
                    </ul>
                     </div>
            </div>
        </footer>
