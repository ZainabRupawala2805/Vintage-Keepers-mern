...
import image1 from '../../asset/img/z.png'
        ...
        <div className="landing__container">
            <div className="landing__header__container">
                <div className="landing__header">
                    <h3 className="landing__header__discount">Introducing the online vintage destination</h3>
                    <h1 className="landing__header__main">VINTAGE FINDS that FIND YOU</h1>
                    <Link to="/shop">
